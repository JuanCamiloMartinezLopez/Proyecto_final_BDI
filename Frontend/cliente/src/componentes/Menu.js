  ...
  return (
    <>
      <div id="caja_menu" style={{ textAlign: "left" }}>
        <div>
          <strong className="h3">
            Bienvenido Usuario : {props.cod_log.info_empleado.empleado.codempleado} - {props.cod_log.info_empleado.empleado.nomempleado} {props.cod_log.info_empleado.empleado.apellempleado}
          </strong>
        </div>
        <div>
        <strong className="h4">
          Sede : {props.cod_log.info_empleado.espacio.nomespacio}
        </strong>
        </div>
        <div>
        <strong className="h5">
          fecha : {props.cod_log.fecha}  {props.cod_log.hora}
        </strong>
        </div>
